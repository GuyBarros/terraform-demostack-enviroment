...
resource "aws_route53_record" "validation_record" {
  name            = aws_acm_certificate.cert.domain_validation_options.domain_name.resource_record_name
  type            = aws_acm_certificate.cert.domain_validation_options.domain_name.resource_record_type
  zone_id         = var.zone_id
  records         = [aws_acm_certificate.cert.domain_validation_options.domain_name.resource_record_value]
  ttl             = "60"
